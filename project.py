...
role=input("Please Enter the Role Applied For:")
date=input("Please Enter Interview Date:")
print(f"""👋 Welcome to your AI Interview for the {role} position

Before we begin, please read the following:

1. **Format**: This is a conversational interview conducted by an AI interviewer. 
   You'll be asked questions one at a time covering your experience, technical/
   role-specific skills, problem-solving ability, and soft skills.

2. **How to respond**: 
   - Answer naturally, as you would in a real interview — in your own words, 
     with relevant examples where possible.
   - Take your time; there's no strict time limit, but aim to be clear and 
     reasonably concise.
   - If a question is unclear, feel free to ask the AI to rephrase or clarify it.

3. **Number of questions**: The interview will cover several key skill areas 
   relevant to {role}. The exact number of questions may vary depending on 
   your responses — the AI may ask follow-up questions if it needs more detail.

4. **What NOT to expect**:
   - The AI will not tell you during the interview whether your answers are 
     "correct" or "good" — this is normal and not a signal either way.
   - The AI cannot discuss salary, offer details, or hiring decisions. Those 
     will be handled separately by our recruiting team.
   - The AI will not answer the interview questions for you or give hints.

5. **Technical tips**:
   - Ensure you're in a quiet environment with a stable internet connection.
   - Type your answers in the chat box and submit when ready.
   - Do not refresh or close the window mid-interview, as this may end your 
     session prematurely.

6. **Conduct**: Please treat this as you would a real interview — professional, 
   honest answers work in your favor. The AI is designed to fairly assess your 
   fit for the role.

7. **After the interview**: Once all areas are covered, the AI will thank you 
   and end the session. Our recruiting team will review the results and reach 
   out with next steps within [5 business days].""")
